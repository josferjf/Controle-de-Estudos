        ...
        function updateUI() {
            ...
            if (currentStep) {
                ...
                if (currentStep.topicLink) {
                    linkButtonsHtml += `<a href="${currentStep.topicLink}" target="_blank" rel="noopener" class="filter-chip topic-link-btn" style="display:inline-flex; padding: 10px 18px; background: var(--primary-alpha); text-decoration:none; font-size:15px;"><i data-lucide="link" style="width:16px; height:16px;"></i>&nbsp;Caderno de Questões</a>`;
                }
                if (currentStep.topicMaterialLink) {
                    linkButtonsHtml += `<a href="${currentStep.topicMaterialLink}" target="_blank" rel="noopener" class="filter-chip topic-link-btn" style="display:inline-flex; padding: 10px 18px; background: var(--primary-alpha); text-decoration:none; font-size:15px;"><i data-lucide="book-open" style="width:16px; height:16px;"></i>&nbsp;Material Teórico</a>`;
                }
