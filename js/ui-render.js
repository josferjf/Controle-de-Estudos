        ...
        function updateUI() {
            ...
            if (currentStep) {
                ...
                if (currentStep.topicLink) {
                    topicLinkContainer.innerHTML = `<a href="${currentStep.topicLink}" target="_blank" rel="noopener" class="filter-chip" style="display:inline-flex; padding: 6px 12px; background: var(--primary-alpha); color: var(--primary); text-decoration:none; font-size:12px;"><i data-lucide="link" style="width:12px; height:12px;"></i>&nbsp;Abrir Caderno de Questões</a>`;
                } else {
                    topicLinkContainer.innerHTML = '';
                }
            ...
            itemsSlice.forEach(([key, data]) => {
                ...
                const linkIcon = step.topicLink ? `<a href="${step.topicLink}" target="_blank" rel="noopener" onclick="event.stopPropagation();" title="Abrir caderno de questões" style="color: var(--primary); display:inline-flex; margin-left:8px;"><i data-lucide="link" style="width:14px; height:14px;"></i></a>` : '';
                ...
                <div style="display:flex; align-items:center;"><span class="badge ${step.isReviewMode ? 'badge-danger' : 'badge-success'}">${step.isReviewMode ? 'Revisão' : 'Teoria'}</span>${linkIcon}</div>`;
            ...
            chartRadarInstance = new Chart(ctxPizza, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        backgroundColor: ['rgba(59, 130, 246, 0.8)', 'rgba(245, 158, 11, 0.8)', 'rgba(239, 68, 68, 0.8)', 'rgba(71, 85, 105, 0.8)', 'rgba(139, 92, 246, 0.8)'],
