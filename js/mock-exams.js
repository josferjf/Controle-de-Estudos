...
// ============================================================
        ...
        function renderMockExams() {
            ...
            if (sorted.length === 0) {
                tbody.innerHTML = `<tr><td colspan="6" style="text-align:center; color:var(--text-muted); padding: 20px;">Nenhum simulado registrado ainda. Cadastre o primeiro no formulário acima.</td></tr>`;
            }
