...
// ============================================================
        ...
        function updateUI() {
            ...
            itemsSlice.forEach(([key, data]) => {
                ...
                const linkIcon = step.topicLink ? `<a href="${step.topicLink}" target="_blank" rel="noopener" onclick="event.stopPropagation();" title="Caderno de Questões" style="color: var(--primary-text); display:inline-flex; margin-left:8px;"><i data-lucide="link" style="width:14px; height:14px;"></i></a>` : '';
                const materialIcon = step.topicMaterialLink ? `<a href="${step.topicMaterialLink}" target="_blank" rel="noopener" onclick="event.stopPropagation();" title="Material Teórico" style="color: var(--primary-text); display:inline-flex; margin-left:8px;"><i data-lucide="book-open" style="width:14px; height:14px;"></i></a>` : '';
                ...
                <div style="display:flex; align-items:center;"><span class="badge ${step.isReviewMode ? 'badge-danger' : 'badge-success'}">${step.isReviewMode ? 'Revisão' : 'Teoria'}</span>${linkIcon}${materialIcon}</div>`;
