...
let chartTopicBarInstance = null;
...
function applyBackwardCompatibilityMigrations() {
    ...
    if (appState.user_configuration.final_stretch_mode === undefined) appState.user_configuration.final_stretch_mode = false;
...
// Escapa texto do usuário antes de inserir via innerHTML, evitando que caracteres como <, >, & ou "
// quebrem a renderização ou sejam interpretados como marcação/script (nomes de matérias, títulos de
// tópicos, nomes de simulados etc. são digitados livremente pelo usuário).
