...
const defaultAppState = {
    ...
    subjects: [
        { id: "subj-1", name: "Direito Constitucional", weight: 3, expected_questions: 15, isActive: true, isStrategicReview: false, last_tudao_review_date: null, topics: [
            { id: "top-1-1", title: "Aula 00: Direitos Individuais", completed: true },
            { id: "top-1-2", title: "Aula 01: Processo Legislativo", completed: false },
            { id: "top-1-3", title: "Aula 02: Controle de Constitucionalidade", completed: false },
            { id: "top-1-4", title: "Aula 03: Poder Executivo", completed: false }
        ]},
        { id: "subj-2", name: "Direito Administrativo", weight: 2, expected_questions: 12, isActive: true, isStrategicReview: false, last_tudao_review_date: null, topics: [
            { id: "top-2-1", title: "Aula 00: Princípios Regime Jurídico", completed: true },
            { id: "top-2-2", title: "Aula 01: Atos Administrativos", completed: true },
            { id: "top-2-3", title: "Aula 02: Nova Lei de Licitações 14.133", completed: false }
        ]}
    ],
    study_cycle: { current_step_index: 0, steps_sequence: [], last_activity_date: new Date().toISOString(), quick_reviews_completed: 0 },
    study_logs: [],
    error_notebook: [],
    mock_exams: [],
    summaries: [],
...
function applyBackwardCompatibilityMigrations() {
    ...
    if (!Array.isArray(appState.summaries)) appState.summaries = [];
    if (appState.study_cycle.quick_reviews_completed === undefined) appState.study_cycle.quick_reviews_completed = 0;
    appState.subjects.forEach(s => { if (s.last_tudao_review_date === undefined) s.last_tudao_review_date = null; });
