        ...
        function updateUI() {
            ...
            if (currentStep) {
                ...
                if (currentStep.topicLink) {
                    topicLinkContainer.innerHTML = `<a href="${currentStep.topicLink}" target="_blank" rel="noopener" class="filter-chip" style="display:inline-flex; padding: 6px 12px; background: var(--primary-alpha); color: var(--primary-text); text-decoration:none; font-size:12px;"><i data-lucide="link" style="width:12px; height:12px;"></i>&nbsp;Abrir Caderno de Questões</a>`;
                } else {
            ...
            itemsSlice.forEach(([key, data]) => {
                ...
                const linkIcon = step.topicLink ? `<a href="${step.topicLink}" target="_blank" rel="noopener" onclick="event.stopPropagation();" title="Abrir caderno de questões" style="color: var(--primary-text); display:inline-flex; margin-left:8px;"><i data-lucide="link" style="width:14px; height:14px;"></i></a>` : '';
