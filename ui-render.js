...
// ============================================================
        ...
        function renderCharts() {
            ...
            chartRadarInstance = new Chart(ctxPizza, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        backgroundColor: ['rgba(198, 234, 60, 0.8)', 'rgba(245, 158, 11, 0.8)', 'rgba(239, 68, 68, 0.8)', 'rgba(71, 85, 105, 0.8)', 'rgba(139, 92, 246, 0.8)'],
            ...
            barGradient.addColorStop(0, '#c6ea3c');
        ...
        function renderConsistencyHeatmap() {
            ...
            function intensityColor(hours) {
                ...
                if (hours < 1) return 'rgba(198, 234, 60, 0.25)';
                if (hours < 2) return 'rgba(198, 234, 60, 0.5)';
                if (hours < 4) return 'rgba(198, 234, 60, 0.75)';
                return 'rgba(198, 234, 60, 1)';
            }
